...
ggplot(map.df, aes(x=long,y=lat,group=group))+
  ...
  coord_map()
```
We can see there majority of the breweries are located in West Coast and North Central Region.
...
```
There are 62 ABV and 1005 IBU missing values and we decided fill in the missing gap with using random sample for ABV and naive Bayes approach for IBU.
...
```
There wasn't a dramatically impact on the median ABV since there wasn't a big missing sample size. However, for the median IBU, we need to observe this carefully because a large portion of the data was missing and we imputed the missing data points. Thie is partically important because South Dakota has no recorded IBU information.
